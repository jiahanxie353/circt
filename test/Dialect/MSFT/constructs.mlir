...
// CHECK-LABEL: msft.module @ChannelExample {} (%clk: !seq.clock, %a: i8) -> (out: i8) {
// CHECK:         [[REG0:%.+]] = msft.constructs.channel %a %clk "chEx"(2) : i8
// CHECK:         msft.output [[REG0]] : i8
// LOWER-LABEL: msft.module @ChannelExample {} (%clk: !seq.clock, %a: i8) -> (out: i8) {
// LOWER:         %chEx_0 = seq.compreg sym @chEx_0 %a, %clk : i8
// LOWER:         %chEx_1 = seq.compreg sym @chEx_1 %chEx_0, %clk : i8
// LOWER:         msft.output %chEx_1 : i8
msft.module @ChannelExample {} (%clk: !seq.clock, %a : i8) -> (out: i8) {
  %out = msft.constructs.channel %a %clk "chEx" (2) : i8
  msft.output %out : i8
}

// CHECK-LABEL: msft.module @foo {} (%in0: i32, %in1: i32, %in2: i32, %clk: !seq.clock) -> (out: i32) {
...
msft.module @foo {} (%in0 : i32, %in1 : i32, %in2 : i32, %clk : !seq.clock) -> (out: i32) {

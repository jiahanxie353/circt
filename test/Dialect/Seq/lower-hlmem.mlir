...
// CHECK-SAME:                  %[[CLK:.*]]: !seq.clock,
// CHECK-SAME:                  %[[VAL_1:.*]]: i1) {
// CHECK:           %[[VAL_2:.*]] = sv.reg  : !hw.inout<uarray<4xi32>>
// CHECK:           %[[HW_CLK:.+]] = seq.from_clock %[[CLK]]
// CHECK:           sv.alwaysff(posedge %[[HW_CLK]]) {
// CHECK:             sv.if %[[VAL_3:.*]] {
...
// CHECK:           %[[VAL_12:.*]] = seq.compreg sym @myMemory_rdaddr0_dly0 %[[VAL_7]], %[[CLK]] : i2
// CHECK:           %[[VAL_13:.*]] = sv.array_index_inout %[[VAL_2]]{{\[}}%[[VAL_12]]] : !hw.inout<uarray<4xi32>>, i2
// CHECK:           %[[VAL_14:.*]] = sv.read_inout %[[VAL_13]] : !hw.inout<i32>
// CHECK:           %[[VAL_15:.*]] = seq.compreg sym @myMemory_rd0_reg %[[VAL_14]], %[[CLK]] : i32
// CHECK:           hw.output
// CHECK:         }

...
// CHECK-SAME:            %[[CLK:.*]]: !seq.clock, %[[VAL_1:.*]]: i1, %[[VAL_2:.*]]: i32, %[[VAL_3:.*]]: i1, %[[VAL_4:.*]]: i1) -> (out: i32) {
...
// CHECK:           %[[VAL_10:.*]] = seq.compreg sym @fifo_count %[[VAL_11:.*]], %[[CLK]], %[[VAL_1]], %[[VAL_9]]  : i2
// CHECK:           %[[VAL_12:.*]] = seq.hlmem @fifo_mem %[[CLK]], %[[VAL_1]] : <3xi32>
// CHECK:           %[[VAL_13:.*]] = seq.compreg sym @fifo_rd_addr %[[VAL_14:.*]], %[[CLK]], %[[VAL_1]], %[[VAL_9]]  : i2
// CHECK:           %[[VAL_15:.*]] = seq.compreg sym @fifo_wr_addr %[[VAL_16:.*]], %[[CLK]], %[[VAL_1]], %[[VAL_9]]  : i2
...
// CHECK-SAME:             %[[CLK:.*]]: !seq.clock, %[[VAL_1:.*]]: i1, %[[VAL_2:.*]]: i32, %[[VAL_3:.*]]: i1, %[[VAL_4:.*]]: i1) -> (out: i32, empty: i1, full: i1, almost_empty: i1, almost_full: i1) {
...
// CHECK:           %[[VAL_13:.*]] = seq.compreg sym @fifo_count %[[VAL_14:.*]], %[[CLK]], %[[VAL_1]], %[[VAL_11]]  : i3
// CHECK:           %[[VAL_15:.*]] = seq.hlmem @fifo_mem %[[CLK]], %[[VAL_1]] : <4xi32>
// CHECK:           %[[VAL_16:.*]] = seq.compreg sym @fifo_rd_addr %[[VAL_17:.*]], %[[CLK]], %[[VAL_1]], %[[VAL_6]]  : i2
// CHECK:           %[[VAL_18:.*]] = seq.compreg sym @fifo_wr_addr %[[VAL_19:.*]], %[[CLK]], %[[VAL_1]], %[[VAL_6]]  : i2

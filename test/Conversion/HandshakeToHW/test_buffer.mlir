...
// CHECK-SAME:          %[[VAL_0:.*]]: !esi.channel<i0>, %[[VAL_1:.*]]: !seq.clock, %[[VAL_2:.*]]: i1) -> (out0: !esi.channel<i0>) {
...
// CHECK-SAME:           %[[VAL_0:.*]]: !esi.channel<i64>, %[[VAL_1:.*]]: !seq.clock, %[[VAL_2:.*]]: i1) -> (out0: !esi.channel<i64>) {
